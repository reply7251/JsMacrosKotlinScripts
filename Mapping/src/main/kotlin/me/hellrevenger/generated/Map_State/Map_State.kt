 ...
 * method_28496
 */
fun <O, S>State<O, S>.createWithMap(arg0: Map<Map<property_Property<*>, Comparable<*>>, S>) = this.method_28496(arg0)
/**
 * method_11654
 */
 ...
 * method_61768
 */
fun <O, S, T>State<O, S>.getNullable(arg0: property_Property<T>) where T: Comparable<T> = this.method_61768<T>(arg0)
/**
 * method_28498
 */
 ...
 * method_61767
 */
fun <O, S, T>State<O, S>.get(arg0: property_Property<T>, arg1: T) where T: Comparable<T> = this.method_61767<T>(arg0, arg1)
/**
 * method_47968
 */
