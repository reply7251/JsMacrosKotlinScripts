...
import me.hellrevenger.generated.PacketCodecs
...
fun <B, K, M, V>KClass<PacketCodecs>.map(arg0: IntFunction<out M>, arg1: PacketCodec<in B, K>, arg2: PacketCodec<in B, V>) where B: ByteBuf, M: Map<K, V> = PacketCodecs.method_56377<B, K, V, M>(arg0, arg1, arg2)
fun <B, K, M, V>KClass<PacketCodecs>.map(arg0: IntFunction<out M>, arg1: PacketCodec<in B, K>, arg2: PacketCodec<in B, V>, arg3: Int) where B: ByteBuf, M: Map<K, V> = PacketCodecs.method_57992<B, K, V, M>(arg0, arg1, arg2, arg3)
