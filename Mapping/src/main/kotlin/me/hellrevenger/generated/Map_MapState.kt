...
import me.hellrevenger.generated.MapState

val MapState.locked by alias(MapState::field_17403)
val MapState.colors by alias(MapState::field_122)
...
val MapState.MAX_SCALE by aliasStatic(MapState::field_31831)
val MapState.MAX_DECORATIONS by aliasStatic(MapState::field_33991)
...
fun MapState.replaceDecorations(arg0: List<MapDecoration>) = this.method_32369(arg0)
