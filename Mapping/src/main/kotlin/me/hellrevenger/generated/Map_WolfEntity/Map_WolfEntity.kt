 ...
 * method_6712
 */
fun WolfEntity.setBegging(begging: Boolean) = this.method_6712(begging)
/**
 * method_58061
 */
 ...
 * method_61477
 */
fun WolfEntity.getShakeProgress(tickDelta: Float) = this.method_61477(tickDelta)
/**
 * method_58063
 */
 ...
 * method_6707
 */
fun WolfEntity.getFurWetBrightnessMultiplier(tickDelta: Float) = this.method_6707(tickDelta)
/**
 * method_6719
 */
fun WolfEntity.getBegAnimationProgress(tickDelta: Float) = this.method_6719(tickDelta)
