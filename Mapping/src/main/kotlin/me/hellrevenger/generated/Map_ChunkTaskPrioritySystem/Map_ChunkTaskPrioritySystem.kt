...
fun <T>KClass<ChunkTaskPrioritySystem>.createTask(arg0: AbstractChunkHolder, arg1: java.util.function.Function<MessageListener<Unit>, T>) = ChunkTaskPrioritySystem.method_34870<T>(arg0, arg1)
...
fun <T>KClass<ChunkTaskPrioritySystem>.createTask(arg0: java.util.function.Function<MessageListener<Unit>, T>, arg1: Long, arg2: IntSupplier) = ChunkTaskPrioritySystem.method_34871<T>(arg0, arg1, arg2)
