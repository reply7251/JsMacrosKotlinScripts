...
val BeeEntity.FLOWER_POS_KEY by aliasStatic(BeeEntity::field_30279)
val BeeEntity.CROPS_GROWN_SINCE_POLLINATION_KEY by aliasStatic(BeeEntity::field_30272)
val BeeEntity.HIVE_POS_KEY by aliasStatic(BeeEntity::field_30280)
val BeeEntity.TICKS_SINCE_POLLINATION_KEY by aliasStatic(BeeEntity::field_30276)
val BeeEntity.CANNOT_ENTER_HIVE_TICKS_KEY by aliasStatic(BeeEntity::field_30273)
val BeeEntity.HAS_STUNG_KEY by aliasStatic(BeeEntity::field_30277)
val BeeEntity.HAS_NECTAR_KEY by aliasStatic(BeeEntity::field_30278)
