...
import me.hellrevenger.generated.Util

val Util.TICKER by aliasStatic(Util::field_37250)
val Util.NIL_UUID by aliasStatic(Util::field_25140)
val Util.JAR_FILE_SYSTEM_PROVIDER by aliasStatic(Util::field_33859)
val Util.nanoTimeSupplier by aliasStatic(Util::field_1128)
fun <V, K>KClass<Util>.mapWith(arg0: Map<K, V>, arg1: K, arg2: V) = Util.method_57109<K, V>(arg0, arg1, arg2)
...
fun <T>KClass<Util>.decodeFixedLengthList(arg0: List<T>, arg1: Int) = Util.method_33141<T>(arg0, arg1)
fun <T>KClass<Util>.withPrepended(arg0: T, arg1: List<T>) = Util.method_58272<T>(arg0, arg1)
...
fun <T>KClass<Util>.lastIndexGetter(arg0: List<T>) = Util.method_43658<T>(arg0)
fun <T>KClass<Util>.make(arg0: Supplier<T>) = Util.method_656<T>(arg0)
fun <V>KClass<Util>.combineCancellable(arg0: List<out CompletableFuture<out V>>) = Util.method_43373<V>(arg0)
...
fun <T>KClass<Util>.getLast(arg0: List<T>) = Util.method_20793<T>(arg0)
...
fun <T>KClass<Util>.anyOf(arg0: List<out Predicate<T>>) = Util.method_56616<T>(arg0)
...
fun <V, K>KClass<Util>.cachedMapper(arg0: Function<K, V>) = Util.method_48746<K, V>(arg0)
...
fun <T>KClass<Util>.isSymmetrical(arg0: Int, arg1: Int, arg2: List<T>) = Util.method_59901<T>(arg0, arg1, arg2)
...
fun <T>KClass<Util>.withAppended(arg0: List<T>, arg1: T) = Util.method_57108<T>(arg0, arg1)
fun KClass<Util>.error(arg0: String, arg1: Throwable) = Util.method_39977(arg0, arg1)
fun <T>KClass<Util>.shuffle(arg0: List<T>, arg1: Random) = Util.method_43028<T>(arg0, arg1)
fun KClass<Util>.error(arg0: String) = Util.method_33559(arg0)
fun KClass<Util>.shutdownExecutors() = Util.method_18350()
fun <V>KClass<Util>.combineSafe(arg0: List<out CompletableFuture<V>>) = Util.method_33791<V>(arg0)
fun KClass<Util>.throwUnchecked(arg0: Throwable) = Util.method_24155(arg0)
fun <T>KClass<Util>.lastIdentityIndexGetter(arg0: List<T>) = Util.method_53909<T>(arg0)
...
fun <T>KClass<Util>.getRandom(arg0: List<T>, arg1: Random) = Util.method_32309<T>(arg0, arg1)
fun <T>KClass<Util>.getRandomOrEmpty(arg0: List<T>, arg1: Random) = Util.method_40083<T>(arg0, arg1)
fun <T>KClass<Util>.allOf(arg0: List<out Predicate<T>>) = Util.method_56613<T>(arg0)
fun KClass<Util>.debugRunnable(arg0: String, arg1: Runnable) = Util.method_33787(arg0, arg1)
fun KClass<Util>.createWorker(arg0: String) = Util.method_28122(arg0)
...
fun <V>KClass<Util>.combine(arg0: List<out CompletableFuture<out V>>) = Util.method_652<V>(arg0)
...
fun <V, K>KClass<Util>.toMap() = Util.method_664<K, V>()
