...
import me.hellrevenger.generated.ServerWorld
...
fun <T>ServerWorld.collectEntitiesByType(arg0: TypeFilter<Entity, T>, arg1: Predicate<in T>, arg2: MutableList<in T>, arg3: Int) where T: Entity = this.method_47539<T>(arg0, arg1, arg2, arg3)
...
fun <T>ServerWorld.collectEntitiesByType(arg0: TypeFilter<Entity, T>, arg1: Predicate<in T>, arg2: MutableList<in T>) where T: Entity = this.method_47538<T>(arg0, arg1, arg2)
