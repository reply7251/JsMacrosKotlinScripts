...
fun <T, E>KClass<RegistryEntryList<T>>.of(arg0: java.util.function.Function<E, RegistryEntry<T>>, arg1: Collection<E>) = RegistryEntryList.method_40244<E, T>(arg0, arg1)
fun <T, E>KClass<RegistryEntryList<T>>.of(arg0: java.util.function.Function<E, RegistryEntry<T>>, arg1: Array<E>) = RegistryEntryList.method_40245<E, T>(arg0, *arg1)
