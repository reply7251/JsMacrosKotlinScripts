...
object TextKt {
     ...
     * method_54158
     */
    fun of(uuid: UUID) = Text.method_54158(uuid)
    /**
     * method_43471
     */
     ...
     * method_30163
     */
    fun of(string: String) = Text.method_30163(string)
    /**
     * method_54157
     */
    fun of(date: Date) = Text.method_54157(date)
    /**
     * method_48322
     */
    fun translatableWithFallback(key: String, fallback: String, args: Array<Object>) = Text.method_48322(key, fallback, *args)
    /**
     * method_43467
     */
     ...
     * method_54155
     */
    fun of(message: Message) = Text.method_54155(message)
    /**
     * method_62790
     */
     ...
     * method_54154
     */
    fun of(id: Identifier) = Text.method_54154(id)
    /**
     * method_61110
     */
    fun of(uri: URI) = Text.method_61110(uri)
    /**
     * method_54159
     */
     ...
     * method_43466
     */
    fun score(name: String, objective: String) = Text.method_43466(name, objective)
    /**
     * method_43469
     */
    fun translatable(key: String, args: Array<Object>) = Text.method_43469(key, *args)
    /**
     * method_43468
     */
