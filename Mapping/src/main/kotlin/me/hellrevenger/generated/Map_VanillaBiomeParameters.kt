...
val KClass<VanillaBiomeParameters>.MAX_HIGH_WEIRDNESS by aliasStatic(VanillaBiomeParameters::field_34502)
val KClass<VanillaBiomeParameters>.MAX_MID_WEIRDNESS by aliasStatic(VanillaBiomeParameters::field_35041)
fun KClass<VanillaBiomeParameters>.getPeaksValleysDescription(arg0: Double) = VanillaBiomeParameters.method_38179(arg0)
fun VanillaBiomeParameters.getErosionParameters() = this.method_40012()
...
fun VanillaBiomeParameters.getHumidityParameters() = this.method_40011()
...
fun VanillaBiomeParameters.getTemperatureParameters() = this.method_40010()
