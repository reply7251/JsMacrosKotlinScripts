...
import me.hellrevenger.generated.RecipeBookResults

fun RecipeBookResults.onRecipesDisplayed(arg0: MutableList<RecipeEntry<*>>) = this.method_2629(arg0)
...
fun RecipeBookResults.getLastClickedRecipe() = this.method_2631()
fun RecipeBookResults.setResults(arg0: MutableList<RecipeResultCollection>, arg1: Boolean) = this.method_2627(arg0, arg1)
fun RecipeBookResults.getLastClickedResults() = this.method_2635()
fun RecipeBookResults.getClient() = this.method_2637()
...
fun RecipeBookResults.getRecipeBook() = this.method_2633()
