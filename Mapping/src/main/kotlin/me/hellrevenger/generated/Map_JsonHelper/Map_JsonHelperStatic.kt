...
object JsonHelperKt {
     ...
     * method_15298
     */
    fun deserialize(content: String, lenient: Boolean) = JsonHelper.method_15298(content, lenient)
    /**
     * method_34921
     */
     ...
     * method_15255
     */
    fun deserialize(reader: Reader) = JsonHelper.method_15255(reader)
    /**
     * method_34928
     */
     ...
     * method_15279
     */
    fun <T>deserialize(gson: Gson, content: String, type: Class<T>, lenient: Boolean) = JsonHelper.method_15279<T>(gson, content, type, lenient)
    /**
     * method_15259
     */
     ...
     * method_15270
     */
    fun getBoolean(arg0: JsonObject, element: String) = JsonHelper.method_15270(arg0, element)
    /**
     * method_15266
     */
     ...
     * method_15285
     */
    fun deserialize(content: String) = JsonHelper.method_15285(content)
    /**
     * method_34929
     */
    fun getByte(arg0: JsonObject, element: String) = JsonHelper.method_34929(arg0, element)
    /**
     * method_15292
     */
     ...
     * method_15288
     */
    fun getItem(arg0: JsonObject, key: String) = JsonHelper.method_15288(arg0, key)
    /**
     * method_15296
     */
    fun getObject(arg0: JsonObject, element: String) = JsonHelper.method_15296(arg0, element)
    /**
     * method_15280
     */
     ...
     * method_15290
     */
    fun <T>deserialize(gson: Gson, content: String, typeToken: TypeToken<T>) = JsonHelper.method_15290<T>(gson, content, typeToken)
    /**
     * method_34925
     */
     ...
     * method_15284
     */
    fun <T>deserialize(gson: Gson, content: String, type: Class<T>) = JsonHelper.method_15284<T>(gson, content, type)
    /**
     * method_43680
     */
     ...
     * method_34917
     */
    fun getBigDecimal(arg0: JsonObject, element: String, defaultBigDecimal: BigDecimal) = JsonHelper.method_34917(arg0, element, defaultBigDecimal)
    /**
     * method_15272
     */
    fun <T>deserialize(arg0: JsonObject, element: String, context: JsonDeserializationContext, type: Class<out T>) = JsonHelper.method_15272<T>(arg0, element, context, type)
    /**
     * method_15295
     */
     ...
     * method_34919
     */
    fun getShort(arg0: JsonObject, element: String, defaultShort: Short) = JsonHelper.method_34919(arg0, element, defaultShort)
    /**
     * method_15265
     */
     ...
     * method_37165
     */
    fun deserializeArray(reader: Reader) = JsonHelper.method_37165(reader)
    /**
     * method_15286
     */
     ...
     * method_47992
     */
    fun <T>deserializeNullable(gson: Gson, reader: Reader, typeToken: TypeToken<T>, lenient: Boolean) = JsonHelper.method_47992<T>(gson, reader, typeToken, lenient)
    /**
     * method_15267
     */
    fun <T>deserialize(gson: Gson, reader: Reader, type: Class<T>, lenient: Boolean) = JsonHelper.method_15267<T>(gson, reader, type, lenient)
    /**
     * method_15253
     */
    fun getString(arg0: JsonObject, element: String, defaultStr: String) = JsonHelper.method_15253(arg0, element, defaultStr)
    /**
     * method_47993
     */
    fun <T>deserializeNullable(gson: Gson, reader: Reader, type: Class<T>, lenient: Boolean) = JsonHelper.method_47993<T>(gson, reader, type, lenient)
    /**
     * method_15274
     */
    fun deserialize(reader: Reader, lenient: Boolean) = JsonHelper.method_15274(reader, lenient)
    /**
     * method_15282
     */
     ...
     * method_15291
     */
    fun <T>deserialize(element: JsonElement, name: String, context: JsonDeserializationContext, type: Class<out T>) = JsonHelper.method_15291<T>(element, name, context, type)
    /**
     * method_15277
     */
    fun getFloat(arg0: JsonObject, element: String, defaultFloat: Float) = JsonHelper.method_15277(arg0, element, defaultFloat)
    /**
     * method_15262
     */
    fun <T>deserialize(gson: Gson, content: String, typeToken: TypeToken<T>, lenient: Boolean) = JsonHelper.method_15262<T>(gson, content, typeToken, lenient)
    /**
     * method_15264
     */
     ...
     * method_15261
     */
    fun getArray(arg0: JsonObject, element: String) = JsonHelper.method_15261(arg0, element)
    /**
     * method_15276
     */
    fun <T>deserialize(gson: Gson, reader: Reader, type: Class<T>) = JsonHelper.method_15276<T>(gson, reader, type)
    /**
     * method_43677
     */
     ...
     * method_34927
     */
    fun getDouble(arg0: JsonObject, element: String) = JsonHelper.method_34927(arg0, element)
    /**
     * method_15257
     */
     ...
     * method_15273
     */
    fun <T>deserialize(gson: Gson, reader: Reader, typeToken: TypeToken<T>, lenient: Boolean) = JsonHelper.method_15273<T>(gson, reader, typeToken, lenient)
    /**
     * method_34918
     */
    fun getBigInteger(arg0: JsonObject, element: String, defaultBigInteger: BigInteger) = JsonHelper.method_34918(arg0, element, defaultBigInteger)
    /**
     * method_15268
     */
     ...
     * method_15283
     */
    fun <T>deserialize(arg0: JsonObject, element: String, defaultValue: T, context: JsonDeserializationContext, type: Class<out T>) = JsonHelper.method_15283<T>(arg0, element, defaultValue, context, type)
    /**
     * method_15260
     */
    fun getInt(arg0: JsonObject, element: String) = JsonHelper.method_15260(arg0, element)
    /**
     * method_15275
     */
     ...
     * method_22449
     */
    fun getLong(arg0: JsonObject, name: String) = JsonHelper.method_22449(arg0, name)
    /**
     * method_34914
     */
    fun getChar(arg0: JsonObject, element: String, defaultChar: Char) = JsonHelper.method_34914(arg0, element, defaultChar)
}