 ...
 * method_1433
 */
fun KeyBinding.matchesMouse(code: Int) = this.method_1433(code)
/**
 * method_16007
 */
 ...
 * method_1417
 */
fun KeyBinding.matchesKey(keyCode: Int, scanCode: Int) = this.method_1417(keyCode, scanCode)
/**
 * method_23481
 */
fun KeyBinding.setPressed(pressed: Boolean) = this.method_23481(pressed)
/**
 * method_1430
 */
