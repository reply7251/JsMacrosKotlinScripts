...
import me.hellrevenger.generated.JsonUtils
...
fun <T>KClass<JsonUtils>.get(arg0: String, arg1: JsonObject, arg2: Function<JsonObject, T>) = JsonUtils.method_49596<T>(arg0, arg1, arg2)
...
fun <T>KClass<JsonUtils>.getNullable(arg0: String, arg1: JsonObject, arg2: Function<JsonObject, T>) = JsonUtils.method_54115<T>(arg0, arg1, arg2)
