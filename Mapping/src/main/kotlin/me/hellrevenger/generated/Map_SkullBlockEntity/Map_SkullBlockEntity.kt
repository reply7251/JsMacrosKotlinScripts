...
val KClass<SkullBlockEntity>.EXECUTOR by aliasStatic(SkullBlockEntity::field_45147)
fun SkullBlockEntity.getNoteBlockSound() = this.method_47888()
...
fun SkullBlockEntity.getOwner() = this.method_11334()
...
fun SkullBlockEntity.getPoweredTicks(arg0: Float) = this.method_47588(arg0)
