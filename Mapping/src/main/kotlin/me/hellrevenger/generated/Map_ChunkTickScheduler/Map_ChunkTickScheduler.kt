...
fun <T>KClass<ChunkTickScheduler<T>>.create(arg0: NbtList, arg1: java.util.function.Function<String, Optional<T>>, arg2: ChunkPos) = ChunkTickScheduler.method_39368<T>(arg0, arg1, arg2)
fun <T>ChunkTickScheduler<T>.toNbt(arg0: Long, arg1: java.util.function.Function<T, String>) = this.method_39365(arg0, arg1)
