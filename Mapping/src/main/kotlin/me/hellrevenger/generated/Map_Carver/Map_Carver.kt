...
fun <C>Carver<C>.carve(arg0: CarverContext, arg1: C, arg2: Chunk, arg3: java.util.function.Function<BlockPos, RegistryEntry<Biome>>, arg4: Random, arg5: AquiferSampler, arg6: ChunkPos, arg7: CarvingMask) where C: CarverConfig = this.method_12702(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
