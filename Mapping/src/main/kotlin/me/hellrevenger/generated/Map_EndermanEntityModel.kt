...
var <T>EndermanEntityModel<T>.angry where T: LivingEntity by alias(EndermanEntityModel<T>::field_3370)
var <T>EndermanEntityModel<T>.carryingBlock where T: LivingEntity by alias(EndermanEntityModel<T>::field_3371)
