...
val instrumentation by lazy { ByteBuddyAgent.install() }
...
val classInjector = ClassInjector.UsingUnsafe.Factory.resolve(instrumentation).make(GetByteCode::class.java.classLoader)
...
class RuntimeMixin {
    companion object {
        ...
        fun createTransformManager() = TransformerManager(InstrumentationClassProvider(instrumentation)).apply {
            ...
            addTransformerPreprocessor(StaticRemover())
            addTransformerPreprocessor(FinalRemover())
        }
